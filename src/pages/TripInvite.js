...
function TripInvite() {
  ...
  const inviteText = useMemo(() => {
    ...
    const link = inviteUrl || 'https://rihlah.io';
    ...
    <div style={styles.page}>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.shareSection}>
          ...
          <button style={styles.shareOption} onClick={handleiMessage}>
          ...
          <button style={styles.shareOption} onClick={handleInstagram}>
          ...
          <button style={styles.shareOption} onClick={handleCopyLink}>
